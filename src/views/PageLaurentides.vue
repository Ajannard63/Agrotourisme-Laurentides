<!--***************************************************
  Nom: Albert Jannard
  Matricule: 2179003
  Description: Page deu portrait de la région des Laurentides
  ***************************************************-->
<script setup>
...
<template>
    <div class="interface">
        ...
        <main>
            <section>
                <h1 class="uppercase text-5xl text-center lg:text-left">Découvrez les laurentides</h1>
                <CarrouselImg/>
                <CarrouselDeText class="w-1/2 mt-36" />
                <!-- <CarteInteractive/> -->
                <MapboxInteractive/>
                <SousNavLaurentide/>
                <ContenuLaurentides/>
